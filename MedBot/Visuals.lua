...
local function OnDraw()
    ...
    if G.Navigation.currentNodeIndex == nil then return end

    -- Visualizing agents
    local agent1Pos = G.Navigation.path[G.Navigation.FirstAgentNode] and G.Navigation.path[G.Navigation.FirstAgentNode].pos
    local agent2Pos = G.Navigation.path[G.Navigation.SecondAgentNode] and G.Navigation.path[G.Navigation.SecondAgentNode].pos
